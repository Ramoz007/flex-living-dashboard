...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={mergeTailwind("size-7", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={mergeTailwind("relative flex w-full min-w-0 flex-col p-2", className)}
      {...props}
    />
  );
}
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={mergeTailwind(sidebarMenuButtonVariants({ variant, size }), className)}
      {...props}
    />
  );
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={mergeTailwind("flex h-8 items-center gap-2 rounded-md px-2", className)}
      {...props}
    >
